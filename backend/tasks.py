...
def inject_b7():
    ...
    if not room:
        ...
        print("Injected Room B7")
    else:
        print("Room B7 already exists")
    
    # Are there students in B7?
    b7_students = list(db["students"].find({"room_number": "B7"}))
    print(f"Found {len(b7_students)} students in B7")
...
def create_student_manual():
    ...
    doc.build(story)
    print("Generated Student_Portal_Manual.pdf")
